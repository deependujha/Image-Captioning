...
def _get_train_data_loader(batch_size, training_dir, is_distributed):
    ...
    train_set = torchvision.datasets.CIFAR10(
        root=training_dir, train=True, download=False, transform=_get_transforms()
    )
...
def _get_test_data_loader(test_batch_size, training_dir):
    ...
    test_set = torchvision.datasets.CIFAR10(
        root=training_dir, train=False, download=False, transform=_get_transforms()
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-type", type=str, default="resnet18", help="custom model or resnet18"
    )
    parser.add_argument(
        "--batch-size",
        type=int,
